        ...
        <form class="needs-validation" novalidate>
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <input type="email" class="form-control" id="email" disabled value="<?php echo htmlspecialchars($email) ?>" placeholder="you@example.com">
              <div class="invalid-feedback">
...
<script src="../assets_bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    ...
    <script src="https://www.paypal.com/sdk/js?client-id=AYF_NpA1BAa-nAYQN01w8gRpTYKBDN15Vf5B5MjKXsjwPN2HvaLaFYAGM3KD6SgWAwOd4bFG8RlvBiw1&currency=MXN"></script>
