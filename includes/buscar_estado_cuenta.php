        ...
        <div class="estado_cuenta_botones">
          ...
          if($total_faltante == 0){
            ...
            //  <button class="btn btn-info btn-block" href="#caja_herramientas" data-toggle="modal" onclick="unificar_cuentas('.$_GET['hab_id'].','.$_GET['estado'].','.$mov.')"> ';
              echo '
              <button  disabled class="btn btn-info btn-block" href="#caja_herramientas" data-toggle="modal" onclick="unificar_cuentas( 0 , 1 ,'.$mov.', '.$folio_casa.')" id="btn_unificar_cuentas"> 
