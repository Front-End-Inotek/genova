      ...
      <table class="table table-bordered table-hover">
        ...
        <tbody>
          <tr class="fuente_menor text-center">
            ...
            <td><button class="btn btn-warning" onclick="editar_herramientas_cargo('.$_GET['id'].','.$_GET['hab_id'].','.$_GET['estado'].','.$_GET['cargo'].')"> Editar</button></td>';
            $monto= 1;
            ...
            echo '<td><button class="btn btn-danger" onclick="aceptar_borrar_herramientas_cargo('.$_GET['id'].','.$_GET['hab_id'].','.$_GET['estado'].','.$_GET['cargo'].')"> Borrar</button></td>
            </tr>
        </tbody>
      </table>
      </div>
