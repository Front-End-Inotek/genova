<?php
  ...
  <div class="modal-content">
    <div class="col-sm-12 fondo" >
          ...
          <div class="row">
            <div class="col-sm-6 altura-rest_total" id="caja_mostrar_funciones" style="background-color:white;">';$pedido->mostar_pedido_funciones($_GET['hab_id'],$_GET['estado'],$mov);echo '</div>
            <div class="col-sm-6 altura-rest_total" id="caja_mostrar_categoria" style="background-color:aliceblue;">';$categoria->mostrar_categoria_restaurente($_GET['hab_id'],$_GET['estado'],$mov);echo '</div>
          </div>
          <div class="row">
