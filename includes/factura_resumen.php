        ...
        <div class="facturas_resumen">
            ...
            <div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="facturado" value="facturado">
                    <label class="form-check-label" for="facturado">Facturado</label>
                </div>
                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="inlineRadioOptions" id="no-facturado" value="no-facturado">
