...
$historial = $cuenta->mostrar_historial_cuentas($inicial,$final,"");
    ...
    <div class="inputs_form_container justify-content-start">
            ...
            <div class="form-floating input_container_date">
              ...
              <label for="incial_historial">Fecha inicial</label>
            </div>

          
            <div class="form-floating input_container_date">
              <input class="form-control custom_input" type="date" id="final_historial" placeholder="Reservacion final" autofocus="autofocus"/>
              <label for="final_historial">Fecha inicial</label>
            </div>

            <div class="form-floating input_container">
              <button class="btn btn-primary" onclick="buscar_historial_cuentas()">
              ...
              <button class="btn btn-primary" onclick="mostrar_reporte_historial()">
