...
<div class="form-group">
    <label for="clave-reserva">Clave de reserva</label>
...
<div class="form-group">
  ...
  <select class="form-control" id="tarifa" onchange="cambiar_adultosNew(event,'.$hab_id.')">
...
<div class="form-group">
  ...
  <input type="number" class="form-control" id="extra_adulto" min="0" required  onchange="nuevo_calculo_total()">
  <input type="number" id="tarifa_adultos" hidden>
</div>
<div class="form-group">
  <label for="menores">Menores</label>
  <input type="number" class="form-control" id="extra_infantil" min="0" required onchange="nuevo_calculo_total()">
  <input type="number" id="tarifa_menores" hidden>
</div>
<div class="form-group">
  <label for="pax-extra">Pax extra</label>
  <input type="number" class="form-control" id="pax-extra" min="0" required  onchange="nuevo_calculo_total()">
</div>
<div class="form-group">
  <label for="plan-alimentos">Plan de alimentos</label>
  <select class="form-control" id="plan-alimentos" required onchange="nuevo_calculo_total(event)">
...
<div class="form-group">
  ...
  <select class="form-control" id="preasignada" required>
...
<button class="btn btn-success btn-block" href="#caja_herramientas" data-toggle="modal" onclick="event.preventDefault(); asignar_huespedNew(0,0,0,0,0)"> Buscar Huésped</button>
<div class="form-group">
