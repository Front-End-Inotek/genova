<?php
  ...
  echo ' </div>';
          echo ' <h2><p><a href="#" class="text-primary">Buscar del '.$fecha_inicial_dia.'-'.$fecha_inicial_mes.'-'.$fecha_inicial_anio.' al '.$fecha_final_dia.'-'.$fecha_final_mes.'-'.$fecha_final_anio.'</a></p></h2>';
          $requisicion->mostrar_requisicion_fecha($_GET['inicial'],$_GET['final'],$_GET['id']);
  echo ' </div>';
?> 
