<?php
    ...
    $folio_casa=$_POST['folio_casa'];
    $lista_tickets=$Tickets->tickets_por_folio_casa($folio_casa);
    ...
    echo '<div class="contenedor_tablas_1_facturas">
          ...
          <p class="ticket_info_p ticket_info_n"><input class="d-none" type="number" id="leer_facturacion" value="0"/></p>
    ';
