			...
			<a href="inicio.php" class="nav-link text-white my-2">
				<img src="images/hotelexpoabastos.png" alt="logo" width="215" height="100" style= "object-fit: contain;">
			</a>
		...
		if($permisos_reportes>0){
			...
			<li href="#" onclick="showMenu(9)" class="nav-link">
				...
				<span class="mx-2 reportes">Facturas</span>
				...
				if($permisos_reportes_diarios>0 || $usuario->nivel==2){
				echo'
				<ul class="contenedor-sub" onclick="sub_menu(); boton_menu();"><a class="subitem" onclick="factura_global()"> Factura individual </a></i></ul>';
				echo'
		...
		<li href="#" onclick="showMenu(7)" class="nav-link">
			...
			echo '
			<ul class="contenedor-sub" onclick="sub_menu(); boton_menu();"><a class="subitem" onclick="config_colores_hab()"> Configuracion colores hab.</a></i></ul>';
			echo '
