<?php
  ...
  // Checar si buscar esta vacia o no
  if (empty($_GET['buscar'])){
    //echo 'La variable esta vacia';
    $actividad= '*';
  }else{
    $actividad= $_GET['buscar'];
  }
  ...
  //{
      $consulta_1=$logs->obtener_logs($usuario,$_GET['fecha_ini'],$_GET['fecha_fin'],$actividad);
  ...
  //$logs->guardar_log($_GET['logs_id'],"Reporte logs del: ". $fecha_inicial_dia.'-'.$fecha_inicial_mes.'-'.$fecha_inicial_anio.' al '.$fecha_final_dia.'-'.$fecha_final_mes.'-'.$fecha_final_anio);
