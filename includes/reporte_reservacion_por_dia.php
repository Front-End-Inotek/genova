  ...
  while ($fila = mysqli_fetch_array($consulta))
  {
      ...
      if($fila['edo'] == 1){
        if($fila['total_pago'] <= 0){
          ...
          $pdf->Cell(21,5,iconv("UTF-8", "ISO-8859-1",$total_estancia),1,0,'C'); 
          $pdf->Cell(21,5,iconv("UTF-8", "ISO-8859-1",$total_pago),1,0,'C'); 
          $pdf->Cell(21,5,iconv("UTF-8", "ISO-8859-1",'Garantizada'),1,1,'C');
        }
      }else{
          $pdf->Cell(-9);
          $pdf->Cell(13,5,iconv("UTF-8", "ISO-8859-1",$numero),1,0,'C');
          ...
          $pdf->Cell(13,5,iconv("UTF-8", "ISO-8859-1",$tipo_habitacion),1,0,'C');
          $pdf->Cell(27,5,iconv("UTF-8", "ISO-8859-1",$huesped),1,0,'C'); 
          $pdf->Cell(21,5,iconv("UTF-8", "ISO-8859-1",$total_estancia),1,0,'C'); 
          $pdf->Cell(21,5,iconv("UTF-8", "ISO-8859-1",$total_pago),1,0,'C'); 
