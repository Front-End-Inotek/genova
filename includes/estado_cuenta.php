      ...
      <div class="main_container">
        ...
        <div class="estado_cuenta_botones">
          ...
          if($total_faltante == 0  && $usuario->combinar_cuentas == 1){
            echo'
              <button  disabled class="btn btn-info btn-block" href="#caja_herramientas" data-toggle="modal" onclick="unificar_cuentas('.$_GET['hab_id'].','.$_GET['estado'].','.$mov.')" id="btn_unificar_cuentas" > 
