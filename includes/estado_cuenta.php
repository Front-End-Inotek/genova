  ...
  echo '
      <div class="main_container">
        <header class="main_container_title">
          ...
          <input class="d-none" type="number" id="leer_hab" value='.$hab->nombre.'>
            </div>
          ';
        ...
        <div class="estado_cuenta_botones">
          ...
          echo '</div></div>
          <div>
            <button class="btn btn-primary" onclick="generar_facturas_global()" disabled id="btn_generador_factura_cargos">
          ...
          if($total_faltante == 0){
            echo'
              <button class="btn btn-primary btn-block" href="#caja_herramientas" data-toggle="modal" onclick="unificar_cuentas('.$_GET['hab_id'].','.$_GET['estado'].','.$mov.')"> 
