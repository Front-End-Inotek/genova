...
$pdf->Cell(30, 5, iconv("UTF-8", "ISO-8859-1", 'Fecha'), 1, 0, 'C',1);
$pdf->Cell(30, 5, iconv("UTF-8", "ISO-8859-1", 'Tipo hab.'), 1, 0, 'C',1);
$pdf->Cell(30, 5, iconv("UTF-8", "ISO-8859-1", 'Cargo'), 1, 0, 'C',1);
$pdf->Cell(30, 5, iconv("UTF-8", "ISO-8859-1", 'Abono'), 1, 0, 'C',1);
$pdf->Cell(20, 5, iconv("UTF-8", "ISO-8859-1", 'Estado'), 1, 0, 'C',1);
$pdf->Cell(50, 5, iconv("UTF-8", "ISO-8859-1", 'Descripción'), 1, 0, 'C',1);
$pdf->Ln();
$pdf->SetTextColor(0, 0, 0);
$c=0;
while ($fila = mysqli_fetch_array($historial)) {
    $estado = $fila['estado_cuenta']== 1 ? "Activo" : "Cerrado";
    $pdf->Cell(30, 5, iconv("UTF-8", "ISO-8859-1", date('Y-m-d',$fila['fecha'])), 1, 0, 'C');
    $pdf->Cell(30, 5, iconv("UTF-8", "ISO-8859-1",$fila['hab_nombre']), 1, 0, 'C');
    $pdf->Cell(30, 5, iconv("UTF-8", "ISO-8859-1", number_format($fila['cargo'],2)), 1, 0, 'C');
    $pdf->Cell(30, 5, iconv("UTF-8", "ISO-8859-1", number_format($fila['abono'],2)), 1, 0, 'C');
    $pdf->Cell(20, 5, iconv("UTF-8", "ISO-8859-1",$estado), 1, 0, 'C');
    $pdf->Cell(50, 5, iconv("UTF-8", "ISO-8859-1", $fila['descripcion']), 1, 1, 'C');
}
