...
echo '
     <div class="form_container">
        ...
        <h2 class="titulo">'.$titulo_.'</h2>
        
        <button class="btn btn-link" onclick="'.$ruta_regreso.'">  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-left-square-fill" viewBox="0 0 16 16">
        <path d="M16 14a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2zm-4.5-6.5H5.707l2.147-2.146a.5.5 0 1 0-.708-.708l-3 3a.5.5 0 0 0 0 .708l3 3a.5.5 0 0 0 .708-.708L5.707 8.5H11.5a.5.5 0 0 0 0-1"></path>
         ...
         <div class="inputs_form_container">
           ...
           <label for="clave-reserva" class="text-right">'.$clv.'</label>
                ...
                <select  class="form-control custom_input" id="habitacion_checkin" name="habitacion_check" onchange="habSeleccionada(event); calcular_nochesChek()" required placeholder="Habitación">
                ...
                <label for="habitacion_checkin" class="asterisco">Habitación</label>
                </div>';
                echo'
                <div class="form-floating input_container">
                <input type="number" class="form-control custom_input" id="total" min="0" step="0.01" value='.$reservacion->total.' readonly placeholder="Total de la estancia">
              ...
              <div class="inputs_form_container">
                <div class="form-floating input_container">
               <input required '.$inputFechaEn.' value="'.date("Y-m-d",$reservacion->fecha_entrada).'" class="form-control custom_input" type="date"  id="fecha_entrada" min='.$dia_actual.' placeholder="Ingresa la fecha de entrada" onchange="calcular_noches('.$hab_id.','.$preasignada.')" placeholder="Llegada">
               <label class="asterisco" for="llegada">Llegada</label>
                ...
                <div class="form-floating input_container">
                <input class="form-control custom_input" type="number" value="'.$reservacion->noches.'" placeholder="Noches" id="noches" placeholder="0" onchange="cambiar_adultosNew("",'.$hab_id.');" disabled/>
               ...
               <div class="inputs_form_container">
                 <div class="form-floating input_container">
                 <select '.$require_tarifa.' class="form-control custom_input" id="tarifa" onchange="cambiar_adultosNew(event,'.$hab_id.')" placeholder="Noches">
                 ...
                 <div class="form-floating input_container">
                  <input type="text" maxlength="10"   onkeypress="validarNumero(event)" class="form-control custom_input" value="'.$forzar_tarifa.'" id="forzar-tarifa" min="0" step="0.01" onchange="cambiar_adultosNew(0,'.$hab_id.')" placeholder="Forzar tarifa">
                  <label for="tipo-habitacion">Forzar tarifa</label>
                </div>

                 <div class="form-floating input_container">
                 <select class="form-control custom_input" id="tipo-habitacion" disabled placeholder="Tipo de habitación">
                 ';
                ...
                -->
                 ...
                 <div class="inputs_form_container">
                   <div class="form-floating input_container">
                   <input type="number" class="form-control custom_input" id="precio_hospedaje" min="0" disabled value="'.$reservacion->precio_hospedaje.'" placeholder="Precio noche">
                   <label for="adultos">Precio noche</label>
                </div>
                
                 <div class="form-floating input_container">
                  <input type="text" maxlength="2"   onkeypress="validarNumero(event)" class="form-control custom_input" id="extra_adulto" min="0"  value="'.$reservacion->adultos.'"  onchange="editarTotalEstancia(); mostrarAcordeonCompleto('.$reservacion->adultos.')" placeholder="Adultos">
                 ...
                 <div class="form-floating input_container">
                 <input type="text" maxlength="2"   onkeypress="validarNumero(event)" class="form-control custom_input" id="extra_infantil" min="0"  value="'.$reservacion->infantiles.'" onchange="editarTotalEstancia()" placeholder="Menores">
                ...
                <div class="inputs_form_container">
                  <div class="form-floating input_container">
                  <input type="text" maxlength="2"   onkeypress="validarNumero(event)" class="form-control custom_input" id="numero_hab" min="1" value="'.$reservacion->numero_hab.'" required onchange="editarTotalEstancia()" placeholder="Número de habitaciones">
                  <label class="asterisco" for="no-habitaciones">Número de habitaciones</label>
                </div>

                   <div class="form-floating input_container">
                   <input type="text" maxlength="10"   onkeypress="validarNumero(event)" class="form-control custom_input" id="pax-extra" min="0" value="'.$reservacion->pax_extra.'"  onchange="editarTotalEstancia()" placeholder="Pax extra">
                   <label for="pax-extra">Pax extra</label>
                </div>

                   <div class="form-floating input_container">
                   <select class="form-control custom_input" id="plan-alimentos"  onchange="editarTotalEstancia(event)" placeholder="Plan de alimentos">
        ...
        <div class="form_title_container">
            ...
            <div class="inputs_form_container">
              ...
              <div class="inputs_form_container">
                <div class="form-floating input_container">
                <input type="tel" class="form-control custom_input" id="telefono" required value="'.$huesped->telefono.'" placeholder="Teléfono">
                <label class="asterisco" for="telefono">Teléfono</label>
                </div>

                <div class="form-floating input_container">
                <input type="text" class="form-control custom_input" id="pais" value="'.$huesped->pais.'" placeholder="País">
               ...
               <div class="inputs_form_container">
                  <div class="form-floating input_container">
                  <input type="text" class="form-control custom_input" id="direccion" value="'.$huesped->direccion.'" placeholder="Dirección">
                ...
                <input class="form-check-input" type="checkbox" id="confirmacion"  role="switch" class="form-check"/>
            ...
            <div class="accordionCustom accordionCustomMostrar" id="acordeonchido">
              ...
              <div class="inputs_form_container">
                  <div class="form-floating input_container">
                  <select class="form-control custom_input" id="forma-garantia" required onchange="obtener_garantia(event)" placeholder="Forma de Garantía">
                  <option value="">Seleccione una opción </option>
                  ';
        ...
        <div class="inputs_form_container">
        <div class="form-floating input_container">
        <textarea class="form-control custom_input" id="observaciones" rows="3" placeholder="Deja una observacion" style="height: 100px">'.$huesped->comentarios.'</textarea>
