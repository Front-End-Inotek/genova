        ...
        echo'
            ...
            <div class="d-flex justify-content-between">
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="esconder" id="leer_nombre_sin_editar" value="'.$huesped->nombre.'"readonly/>
                </div>
                <div class="form-group col-md-4">
                    ...
                    <input type="text" class="esconder" id="leer_apellido_sin_editar" value="'.$huesped->apellido.'"readonly/>
                </div>
                <div class="form-group col-md-4">
