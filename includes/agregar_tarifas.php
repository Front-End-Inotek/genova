        ...
        <div class="modal-body">
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                  ...
                  <input type="number" id="precio_hospedaje" name ="precio_hospedaje" value="" class="form-control" aria-label="Default" autocomplete="off" aria-describedby="inputGroup-sizing-default" style="font-size: 16px;" >
            </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                  ...
                  <input type="number" id="cantidad_hospedaje" name ="cantidad_hospedaje" value="" class="form-control" aria-label="Default" autocomplete="off" aria-describedby="inputGroup-sizing-default" style="font-size: 16px;" >
            </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                  ...
                  <input type="number" id="cantidad_maxima" name ="cantidad_maxima" value="" class="form-control" aria-label="Default" autocomplete="off" aria-describedby="inputGroup-sizing-default" style="font-size: 16px;" >
            </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                  ...
                  <input type="number" id="precio_adulto" name ="precio_adulto" value="" class="form-control" aria-label="Default" autocomplete="off" aria-describedby="inputGroup-sizing-default" style="font-size: 16px;" >
            </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                  ...
                  <input type="number" id="precio_junior" name ="precio_junior" value="" class="form-control" aria-label="Default" autocomplete="off" aria-describedby="inputGroup-sizing-default" style="font-size: 16px;" >
            </div>
            ...
            <div class="input-group mb-3">
                <div class="input-group-prepend">
                  ...
                  <input type="number" id="precio_infantil" name ="precio_infantil" value="" class="form-control" aria-label="Default" autocomplete="off" aria-describedby="inputGroup-sizing-default" style="font-size: 16px;" >
            </div>
