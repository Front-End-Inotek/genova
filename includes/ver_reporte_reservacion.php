            ...
            <header class="main_container_title">
              ...
              <div class="btn_resumen_reservacion">
                  ...
                  if($titulo=="RESERVACIÓN"){
                    $ruta_imagen = $reservacion->sacar_nombre_imagen($_GET['id']);
                    if (!$ruta_imagen) {
                      $btn = "disabled='true'";
                    } else {
                      $btn = "";
                    ...
                    <div  id="boton_reservacion">
                    <button type="submit" class="btn btn-primary" value="Reenviar" onclick="agregar_comprobante('.$_GET['id'].')">
                    ...
                    <div  id="boton_reservacion">
                    <button type="submit" class="btn btn-primary" '.$btn.'  value="Reenviar" onclick="ver_comprobante(\''.$ruta_imagen.'\')">
