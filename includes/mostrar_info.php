...
<div class="modal-body">
  <ul class="list-group mb-4">
      ...
      echo '<li class="list-group-item" style="background-color: '.$color.'"><p class="InfoHab" style="color: '.$color.';  filter: invert(1) grayscale(100%); font-weight: 600;">'.$fila['nombre'].'</p></li>';
      }
  echo '
  </ul>
  <ul class="list-group mb-4">
